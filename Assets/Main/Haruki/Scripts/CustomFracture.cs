...
public class CustomFracture : MonoBehaviour
{
    ...
    public void ComputeFracture()
    {
        ...
        if (mesh != null)
        {
            ...
            // FIXED
            Invoke(nameof(DestoryFracture), 3.5f);
        }
    }
    ...
    {
        var fractureComponent = obj.AddComponent<CustomFracture>();
    ...
    private void DestoryFracture()
    {
        // FIXED
        GameObject.Destroy(this.fragmentRoot);
    }
}
